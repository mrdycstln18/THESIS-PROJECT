...
<br>
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a type="button" class="nav-link" data-toggle="modal" data-target="#AddOperator" style="background: #4a89ff;">
          <i class="#"></i>
          <span>Add Operator</span></a>
              <?php 
                include ('modal/prodhead/addoperator.php');
              ?>
      </li>

      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" data-toggle="modal" data-target="AddMachine">
          <i class="#"></i>
