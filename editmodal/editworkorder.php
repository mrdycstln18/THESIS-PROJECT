    ...
    <div id="AddMachine" class="modal fade" role="dialog">
     ...
     <div class="modal-body"><br>
      ...
      <table width="720">
        ...
        <tr>
          <td colspan="2"><input type="text" placeholder="Job Description:" name="jobdesc" class="form-control"></td>
        </tr>
        <tr>
          <td colspan="2"><input type="text" placeholder="Supplier Name:" name="supname" class="form-control"></td>
        </tr>
        <tr>
          <td colspan="2"><input type="text" placeholder="Instruction:" name="jobinst" class="form-control"></td>
        </tr>
      </table>
